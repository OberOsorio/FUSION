            ...
            <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6 relative z-10">
              ...
              <div className="space-y-2 max-w-2xl">
                <div className="flex items-center gap-2">
                  <span className="px-3 py-1 rounded-full bg-emerald-500/20 border border-emerald-400/40 text-emerald-300 font-extrabold text-[10px] uppercase tracking-wider flex items-center gap-1.5">
                    <Activity className="w-3.5 h-3.5 text-emerald-400 animate-pulse" /> Auditoría Político-Electoral 360°
                  </span>
                  <span className="text-xs text-slate-400 font-mono">Última Inspección: {lastDiagnosticDate}</span>
                </div>
                ...
                <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">
                  Evaluación multicriterio de la salud electoral en tiempo real. Analiza la cobertura territorial, finanzas CNE, control de testigos para el Día E, efectividad del mensaje y blindaje contra duplicidad en el censo.
                </p>
              </div>
            ...
            <div className="mt-4 p-4 bg-[#081d38] border border-cyan-500/30 rounded-2xl text-xs">
              <div className={`p-3.5 rounded-xl border transition-all ${
                ...
                <div className="flex items-center gap-2 text-emerald-400 font-extrabold text-xs mb-1">
                  ...
                  <span>DIAGNÓSTICO DE LA CAMPAÑA (Auditoría Político-Electoral)</span>
                </div>
                <p className="text-slate-300 text-[11px] leading-relaxed">
                  <strong>Evaluación Interna de Competitividad:</strong> Mide la salud operativa de la maquinaria electoral (censo, testigos Día E, finanzas CNE, fortaleza del candidato y blindaje de comunicaciones).
                </p>
                <div className="mt-2 text-[10px] text-emerald-300 font-mono bg-emerald-950/60 p-1.5 rounded border border-emerald-500/20">
                  🎯 Insumo que genera: Plan de Acción Operativo, Estrategia Día E y Presupuesto.
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 border-b border-cyan-500/20 pb-5">
                <div>
                  ...
                  <p className="text-xs text-slate-300 mt-1 leading-relaxed">
                    Evaluación multidimensional por sectores temáticos (Salud, Seguridad, Educación, etc.) alimentada de los <strong>Sondeos de Opinión</strong> del sistema para construir el <strong>Programa de Gobierno</strong>.
                  </p>
                </div>
                ...
                <div className="bg-[#081d38] border border-cyan-500/30 p-3.5 rounded-2xl flex flex-col sm:flex-row items-center justify-between gap-3 shrink-0">
                  <div className="text-left space-y-0.5">
                    <div className="flex items-center gap-2 text-[11px] font-bold text-teal-300">
                      ...
                      <span>Móvil Sondeos de Opinión Activo</span>
                    </div>
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-cyan-500/20 pb-4">
                <div>
                  ...
                  <p className="text-xs text-slate-300 mt-0.5">
                    Responda las 10 preguntas tácticas para recalcular el riesgo y medir la madurez de la campaña antes del cierre electoral.
                  </p>
                </div>
            ...
            <div className="border-2 border-dashed border-cyan-500/40 hover:border-emerald-400 bg-[#081d38]/60 p-8 rounded-2xl flex flex-col items-center justify-center text-center transition-all group">
              ...
              {cvFileName && (
                <div className="mt-4 px-3 py-1.5 rounded-lg bg-emerald-950/80 border border-emerald-400/40 text-emerald-300 text-xs font-mono flex items-center gap-2">
                  ...
                  <span className="bg-emerald-500 text-slate-950 text-[10px] font-black px-1.5 py-0.5 rounded ml-2">VERIFICADO OCR</span>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="bg-[#05162a] border border-cyan-500/30 rounded-3xl p-6 shadow-xl space-y-4">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-cyan-500/20 pb-4">
              ...
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-emerald-400 to-teal-400 text-slate-950 font-extrabold text-xs rounded-xl shadow-md transition-all cursor-pointer"
              >
