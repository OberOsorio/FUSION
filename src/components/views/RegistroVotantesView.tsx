        ...
        {reassignModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-xs">
            <motion.div
              ...
              className="bg-white rounded-3xl p-6 shadow-2xl border border-slate-200 max-w-md w-full space-y-4"
            >
              <div className="flex items-center justify-between border-b border-slate-100 pb-3">
                ...
                <button
                  ...
                  className="text-slate-400 hover:text-slate-600 font-extrabold text-sm p-1 rounded-lg"
                >
                  ✕
                </button>
              </div>
              ...
              <div className="space-y-3 text-xs">
                <div className="bg-slate-50 p-3 rounded-2xl border border-slate-200 space-y-1">
                  <span className="text-slate-500 font-medium block">Votante:</span>
                  <span className="font-extrabold text-slate-900 text-sm">{reassignModal.voterName}</span>
                  <div className="text-slate-500 text-[11px] pt-1">
                    Líder Actual: <strong className="text-slate-800 font-bold">{reassignModal.currentLeader}</strong>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-slate-50 border border-slate-300 rounded-xl px-3 py-2.5 text-xs font-bold text-slate-900 outline-none focus:border-teal-600 cursor-pointer"
                  >
                    {authUser?.name && (
        ...
        {duplicateReport.isOpen && duplicateReport.record && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-md overflow-y-auto">
            <motion.div
              ...
              className="bg-white border-2 border-rose-500 rounded-3xl max-w-2xl w-full shadow-2xl overflow-hidden text-slate-800 my-8"
            >
              {/* Modal Header */}
                ...
                <div className="border border-slate-200 rounded-2xl p-4 bg-slate-50 space-y-3">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
                    <div className="bg-white p-3 rounded-xl border border-slate-200">
                      ...
                      <strong className="text-slate-900 text-sm font-black">{duplicateReport.record.nombreCompleto}</strong>
                    </div>

                    <div className="bg-white p-3 rounded-xl border border-slate-200">
                      <span className="text-[10px] text-slate-400 uppercase font-extrabold block">Cédula de Ciudadanía:</span>
                      <strong className="text-slate-900 text-sm font-mono font-black">{duplicateReport.record.cedula}</strong>
                    </div>
                    ...
                    <div className="bg-white p-3 rounded-xl border border-slate-200">
                      ...
                      <span className="text-slate-800 font-mono font-bold flex items-center gap-1">
                        <Phone className="w-3 h-3 text-slate-500" /> {duplicateReport.record.telefono}
                      </span>
                    </div>
                    ...
                    <div className="bg-white p-3 rounded-xl border border-slate-200">
                      ...
                      <span className={`inline-block px-2 py-0.5 rounded font-bold text-[10px] mt-0.5 ${
                        duplicateReport.type === 'activo' ? 'bg-emerald-100 text-emerald-900 border border-emerald-300' : 'bg-amber-100 text-amber-900 border border-amber-300'
                      }`}>
              ...
              <div className="bg-slate-100 p-4 border-t border-slate-200 flex flex-col gap-3">
                <div className="flex flex-wrap items-center justify-between gap-2.5">
                  ...
                  <div className="flex items-center gap-2 w-full sm:w-auto justify-end">
                    ...
                    <button
                      type="button"
                      onClick={() => setDuplicateReport(prev => ({ ...prev, isOpen: false }))}
                      className="px-5 py-2.5 bg-slate-200 hover:bg-slate-300 text-slate-800 font-extrabold text-xs rounded-xl cursor-pointer"
                    >
                      Cerrar
                    </button>
                  </div>
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 relative z-10">
          <div className="space-y-2 max-w-3xl">
            <div className="flex flex-wrap items-center gap-2">
              ...
              <span className="px-3 py-1 rounded-full bg-amber-500/20 border border-amber-400/40 text-amber-300 font-extrabold text-[10px] uppercase tracking-wider flex items-center gap-1.5">
      ...
      <div className={`p-4 rounded-2xl border flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 text-xs shadow-md transition-all ${
        ...
        <div className="flex items-center gap-3">
          <div className={`p-2.5 rounded-xl font-bold shrink-0 ${
            strictLeaderMode ? 'bg-emerald-500/20 text-emerald-300 border border-emerald-400/40' : 'bg-amber-500/20 text-amber-300 border border-amber-400/40'
          }`}>
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className={`px-2 py-0.5 rounded text-[9px] font-mono font-bold ${
                strictLeaderMode ? 'bg-emerald-500/30 text-emerald-200 border border-emerald-400/40' : 'bg-amber-500/30 text-amber-200 border border-amber-400/40'
              }`}>
        ...
        {isAdmin ? (
          ...
          <div className="px-3.5 py-2 bg-emerald-500/20 border border-emerald-400/40 text-emerald-300 rounded-xl font-black text-xs flex items-center gap-1.5 shrink-0">
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto">
          ...
          {isAdmin ? (
            ...
            <div className="px-3 py-1.5 bg-slate-800/90 text-teal-300 border border-teal-500/40 rounded-xl font-bold text-xs flex items-center gap-1.5">
              ...
              <span className="px-1.5 py-0.5 bg-amber-500/20 text-amber-300 text-[9px] rounded font-mono border border-amber-500/30">
                Líder Exclusivo
              </span>
            </div>
          )}
      ...
      {activeTab === 'activos' ? (
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      className="w-full bg-slate-50 border border-slate-300 rounded-xl px-3.5 py-2.5 text-sm font-mono text-slate-900 outline-none focus:border-teal-600 focus:bg-white transition-all"
                    />
                    <button
                      type="button"
                ...
                <div className="space-y-1.5 pt-1">
                  ...
                  <div className="flex flex-wrap gap-1.5 text-[10px]">
                    <button
                      ...
                      className="px-2 py-1 bg-rose-50 hover:bg-rose-100 text-rose-800 border border-rose-300 rounded-lg font-mono font-bold cursor-pointer flex items-center gap-1"
                    ...
                    <button
                      ...
                      className="px-2 py-1 bg-amber-50 hover:bg-amber-100 text-amber-900 border border-amber-300 rounded-lg font-mono font-bold cursor-pointer"
                    >
                    ...
                    {consultaResult.encontrado && consultaResult.esCircunscripcionPermitida ? (
                      ...
                      <div className="bg-gradient-to-b from-emerald-50 to-teal-50 border border-emerald-300 p-4 rounded-2xl space-y-3">
                        ...
                        <div className="text-xs space-y-1.5 text-slate-800">
                          <div>
                            <span className="text-slate-500 text-[11px] block">Nombre registrado en Censo:</span>
                            <strong className="text-slate-900 font-extrabold text-sm">{consultaResult.nombreCompleto}</strong>
                          </div>

                          <div className="grid grid-cols-2 gap-2 pt-1 font-mono text-[11px]">
                            <div className="bg-white/80 p-2 rounded-xl border border-emerald-200">
                              <span className="text-[9px] text-slate-500 block uppercase font-sans font-bold">Circunscripción</span>
                              <span className="font-bold text-teal-800">{consultaResult.municipio} ({consultaResult.departamento})</span>
                            </div>

                            <div className="bg-white/80 p-2 rounded-xl border border-emerald-200">
                              <span className="text-[9px] text-slate-500 block uppercase font-sans font-bold">Comuna / Sector</span>
                        ...
                        <p className="text-[11px] text-emerald-800 font-medium leading-relaxed bg-emerald-100/60 p-2 rounded-xl border border-emerald-200">
                      ...
                      <div className="bg-gradient-to-b from-amber-50 to-orange-50 border border-amber-300 p-4 rounded-2xl space-y-3">
                        ...
                        <p className="text-xs text-amber-900 font-semibold leading-relaxed bg-white/90 p-3 rounded-xl border border-amber-200">
                          {consultaResult.mensajeRespuesta}
                        </p>

                        <div className="text-[10px] text-amber-800 bg-amber-100/80 p-2 rounded-xl flex items-start gap-2 border border-amber-200">
                        ...
                        <div className="bg-white p-3 rounded-2xl border border-amber-300 space-y-2.5 text-xs">
                          ...
                          <div className="space-y-2">
                            <div>
                              <label className="block text-[10px] font-bold text-slate-700">Nombre Completo:</label>
                              <input
                                type="text"
                            ...
                            <div>
                              <label className="block text-[10px] font-bold text-slate-700">Teléfono / WhatsApp:</label>
                              <input
                                type="text"
                            ...
                            <div>
                              <label className="block text-[10px] font-bold text-slate-700">Líder o Miembro Asignado:</label>
                              <select
                            ...
                            <div>
                              <label className="block text-[10px] font-bold text-slate-700">Observaciones del Traslado:</label>
                              <input
                                type="text"
                          ...
                          {!isAdmin ? (
                            <div className="p-2.5 bg-amber-50 border border-amber-300 rounded-xl text-amber-900 text-xs font-bold flex items-center justify-center gap-2">
            ...
            <div className="lg:col-span-7 bg-white border border-slate-200 rounded-3xl p-6 shadow-xl space-y-5 flex flex-col justify-between">
              <div>
                <div className="border-b border-slate-100 pb-3 flex items-center justify-between">
                  ...
                  {consultaResult && consultaResult.encontrado && consultaResult.esCircunscripcionPermitida ? (
                    <span className="px-3 py-1 bg-emerald-100 border border-emerald-300 text-emerald-800 text-[10px] font-extrabold rounded-full flex items-center gap-1">
                      <Check className="w-3 h-3 text-emerald-600" /> Censo Verificado
                    </span>
                  ) : (
                    <span className="px-3 py-1 bg-slate-100 border border-slate-200 text-slate-500 text-[10px] font-bold rounded-full">
                ...
                <form onSubmit={handleRegisterVotante} className="space-y-4 pt-3">
                  {!isAdmin && (
                    <div className="bg-amber-50 border border-amber-300 p-3 rounded-2xl flex items-center gap-2.5 text-amber-900 text-xs font-medium">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full bg-slate-50 border border-slate-300 rounded-xl px-3 py-2 text-xs font-bold text-slate-900 outline-none focus:border-teal-600 focus:bg-white disabled:opacity-50"
                      />
                    </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full bg-slate-50 border border-slate-300 rounded-xl px-3 py-2 text-xs text-slate-800 outline-none focus:border-teal-600 focus:bg-white disabled:opacity-50"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full bg-slate-50 border border-slate-300 rounded-xl px-3 py-2 text-xs font-extrabold text-slate-900 outline-none focus:border-teal-600 focus:bg-white disabled:opacity-50 cursor-pointer"
                      >
                        {authUser?.name && (
                          <option value={`${authUser.name} (${authUser.roleName || 'Usuario Campaña'})`}>
                            📌 Mi Usuario: {authUser.name} ({authUser.roleName})
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                      ...
                      <select
                        ...
                        className="w-full bg-slate-50 border border-slate-300 rounded-xl px-3 py-2 text-xs font-extrabold text-slate-800 outline-none focus:border-teal-600 focus:bg-white disabled:opacity-50 cursor-pointer"
                      >
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full bg-slate-50 border border-slate-300 rounded-xl px-3 py-2 text-xs text-slate-800 outline-none focus:border-teal-600 focus:bg-white disabled:opacity-50 resize-none"
                    />
                  </div>
                  ...
                  {!isAdmin ? (
                    <button
                      type="button"
                      disabled
                      className="w-full py-3 bg-slate-100 text-slate-500 border border-slate-300 font-extrabold text-xs uppercase tracking-wider rounded-xl flex items-center justify-center gap-2 cursor-not-allowed shadow-inner"
                    >
          ...
          <div className="bg-white border border-slate-200 rounded-3xl p-6 shadow-xl space-y-4">
            ...
            {/* SEARCH & FILTERS BAR */}
            <div className="flex flex-col lg:flex-row items-center justify-between gap-3 bg-slate-50 p-3 rounded-2xl border border-slate-200">
              ...
              <div className="relative w-full lg:w-72">
                ...
                <input
                  ...
                  className="w-full bg-white border border-slate-200 rounded-xl pl-9 pr-3 py-1.5 text-xs text-slate-800 outline-none focus:border-teal-500 font-medium"
                />
              </div>
              ...
              <div className="flex flex-wrap items-center gap-2 w-full lg:w-auto">
                ...
                {isAdmin ? (
                  <select
                    ...
                    className="bg-white border border-teal-300 rounded-xl px-2.5 py-1.5 text-xs text-teal-900 font-bold outline-none cursor-pointer"
                  >
                ...
                <select
                  ...
                  className="bg-white border border-slate-200 rounded-xl px-2.5 py-1.5 text-xs text-slate-700 font-semibold outline-none cursor-pointer"
                >
                    ...
                    filteredVotantes.map((v) => {
                      ...
                      return (
                        <tr key={v.id} className="hover:bg-teal-50/40 transition-all">
                          ...
                          <td className="p-3">
                            <div className="font-mono font-bold text-slate-900">{v.cedula}</div>
                          ...
                          <td className="p-3">
                            <div className="font-bold text-slate-800">{v.puestoVotacion}</div>
                          ...
                          <td className="p-3">
                            {v.requiereTransporte ? (
                              <span className="px-2 py-0.5 bg-amber-100 text-amber-800 font-extrabold rounded text-[10px] border border-amber-300 flex items-center gap-1 w-fit">
                          ...
                          <td className="p-3">
                            <span className="px-2 py-0.5 bg-emerald-50 text-emerald-800 font-bold rounded text-[10px] border border-emerald-200 flex items-center gap-1 w-fit">
                          ...
                          <td className="p-3 text-right space-y-1">
                            <button
                              ...
                              className="px-2 py-1 bg-slate-100 hover:bg-teal-100 text-teal-800 border border-slate-200 hover:border-teal-300 font-extrabold text-[10px] rounded-lg transition-all flex items-center gap-1 ml-auto cursor-pointer"
                  ...
                  {filteredArchivados.length === 0 ? (
                    ...
                    filteredArchivados.map((item) => {
                      ...
                      return (
                        ...
                        >
                          <td className="p-3">
                            <div className="font-mono font-bold text-slate-900">{item.cedula}</div>
                            <div className="font-extrabold text-slate-900 text-xs">{item.nombreCompleto}</div>
                            <div className="text-[10px] text-slate-500 flex items-center gap-1">
                          ...
                          <td className="p-3">
                            <div className="font-bold text-slate-800">{item.circunscripcionOriginal}</div>
                          ...
                          <td className="p-3 max-w-xs text-[11px] text-slate-600 leading-snug">
                            {item.motivo}
                          </td>
                          ...
                          <td className="p-3">
                            {isUpdated ? (
                              <div className="space-y-1">
                                <span className="px-2.5 py-1 bg-emerald-500 text-white font-black rounded-full text-[10px] uppercase flex items-center gap-1 w-fit shadow animate-pulse">
                                  <BellRing className="w-3 h-3" /> ¡Lugar Actualizado a Medellín!
                                </span>
                                {item.puestoNuevoMedellin && (
                                  <div className="text-[10px] text-emerald-950 font-bold bg-emerald-100/80 p-1.5 rounded-lg border border-emerald-300">
                              ...
                              <div className="space-y-1">
                                <span className="px-2.5 py-1 bg-amber-100 text-amber-900 font-extrabold rounded-full text-[10px] border border-amber-300 flex items-center gap-1 w-fit">
                          ...
                          <td className="p-3 text-right space-y-1">
                            {isUpdated ? (
                              ...
                              <button
                                ...
                                className="px-2.5 py-1 bg-slate-100 hover:bg-emerald-100 text-slate-700 hover:text-emerald-900 border border-slate-300 hover:border-emerald-400 font-bold text-[10px] rounded-lg transition-all flex items-center gap-1 ml-auto cursor-pointer"
