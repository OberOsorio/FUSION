...
export const ConfiguracionView: React.FC<ConfiguracionViewProps> = ({ onSelectView }) => {
  ...
  const [ocrAutoApproval, setOcrAutoApproval] = useState(true);
  const [dafoSensitivity, setDafoSensitivity] = useState('Alta');
  const [aiTone, setAiTone] = useState('Estratégico Diplomático');
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-slate-300 mt-1">
              Administración centralizada de parámetros de campaña, modelos de IA, claves API y seguridad.
            </p>
          </div>
        </div>
