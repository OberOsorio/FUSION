...
export const GestionTerritorial: React.FC<GestionTerritorialProps> = ({
  ...
  return (
    <div className="min-h-[calc(100vh-60px)] bg-slate-100 text-slate-800 p-4 md:p-6 space-y-4">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 bg-white p-2 rounded-2xl border border-slate-200 shadow-sm">
        <div className="flex items-center gap-2">
          ...
          >
            ...
            <span className="px-2 py-0.5 rounded-full bg-emerald-500/20 text-emerald-300 border border-emerald-400/40 text-[9px] font-extrabold uppercase font-mono">
      ...
      {activeSubTab === 'registro' ? (
        ...
        <div className="lg:col-span-8 bg-white rounded-3xl border border-slate-200 p-4 shadow-sm relative flex flex-col justify-between min-h-[520px] overflow-hidden">
          ...
          <div 
            className="relative flex-1 my-3 bg-gradient-to-br from-slate-50 via-teal-50/20 to-sky-50 rounded-2xl border border-slate-200 overflow-hidden flex items-center justify-center transition-all"
          ...
          >
            ...
            {[
              ...
              <div
                ...
                className={`absolute -translate-x-1/2 -translate-y-1/2 bg-white/90 backdrop-blur border-2 border-[#0284c7] text-[#0369a1] font-black rounded-full shadow-lg flex items-center justify-center cursor-pointer hover:scale-125 transition-transform ${
      ...
      <div className="bg-[#0b1b36] border border-slate-800/90 text-white rounded-3xl p-5 md:p-6 shadow-xl space-y-5">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-800 pb-4">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-3.5 py-2 rounded-xl bg-teal-500 hover:bg-teal-400 text-slate-950 font-extrabold text-xs transition-all cursor-pointer shadow-md shadow-teal-950/40 shrink-0 self-start sm:self-auto"
          >
