      ...
      <main className="p-4 md:p-8 space-y-6 max-w-7xl mx-auto">
        ...
        {activeTab === 'inicio' && (
          <div className="space-y-6 animate-fadeIn">
            ...
            <div className="bg-gradient-to-r from-[#0b1d38] via-[#0d2a4a] to-[#047857] rounded-2xl p-6 text-white shadow-xl relative overflow-hidden">
              <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 relative z-10">
                <div>
                  <h2 className="text-xl font-extrabold tracking-tight">Centro de Mando Administrativo de Campaña</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div className="bg-[#041733]/90 rounded-2xl p-4 border border-cyan-500/30 shadow-lg flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-black text-white mt-1">14,850</p>
                  <span className="text-[10px] text-cyan-400 font-bold flex items-center gap-1 mt-1">
                    <Users className="w-3 h-3" /> Sin Duplicados en Censo
                  </span>
                </div>
              ...
              <div className="bg-[#041733]/90 rounded-2xl p-4 border border-cyan-500/30 shadow-lg flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-black text-white mt-1">62.4%</p>
                  <span className="text-[10px] text-amber-400 font-bold flex items-center gap-1 mt-1">
                    <DollarSign className="w-3 h-3" /> Topes Legales OK
                  </span>
                </div>
              ...
              <div className="bg-[#041733]/90 rounded-2xl p-4 border border-cyan-500/30 shadow-lg flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-black text-white mt-1">240 / 185</p>
                  <span className="text-[10px] text-emerald-400 font-bold flex items-center gap-1 mt-1">
                    <Award className="w-3 h-3" /> Formulario E-16 Listo
                  </span>
                </div>
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-cyan-500/20 pb-4">
                <div>
                  ...
                  <p className="text-xs text-cyan-200/80 mt-0.5">
                    Modifique privilegios granulares y supervise los usuarios asignados a cada nivel de acceso.
                  </p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="p-4 rounded-xl bg-[#030d1f]/60 border border-cyan-500/10 flex flex-col items-center justify-center text-center gap-2 shadow-md">
                  ...
                  <div className="text-[9px] text-slate-400 font-semibold mt-1">
                    {assignedUsers.admin.length} Usuarios: {assignedUsers.admin.join(', ')}
                  </div>
                </div>
                ...
                <div className="p-4 rounded-xl bg-[#030d1f]/60 border border-cyan-500/10 flex flex-col items-center justify-center text-center gap-2 shadow-md">
                  ...
                  <div className="text-[9px] text-slate-400 font-semibold mt-1">
                    {assignedUsers.estrategico.length} Usuarios: {assignedUsers.estrategico.join(', ')}
                  </div>
                </div>
                ...
                <div className="p-4 rounded-xl bg-[#030d1f]/60 border border-cyan-500/10 flex flex-col items-center justify-center text-center gap-2 shadow-md">
                  ...
                  <p className="text-[11px] text-emerald-200/65 leading-relaxed">
                    Registro de votantes, mensajería masiva y coordinación de testigos/jurados.
                  </p>
                  <div className="text-[9px] text-slate-400 font-semibold mt-1">
                    {assignedUsers.territorial.length} Usuarios: {assignedUsers.territorial.join(', ')}
                  </div>
                </div>
              </div>
        ...
        {activeTab === 'lideres_votantes' && (
          <div className="space-y-6 animate-fadeIn">
            ...
            <div className="flex items-center gap-2 bg-[#030d1f] p-1.5 rounded-2xl border border-cyan-500/30">
              <button
              ...
              <button
                ...
                className={`flex-1 py-2.5 px-4 rounded-xl text-xs font-bold transition-all flex items-center justify-center gap-2 cursor-pointer ${
                  formTypeSubTab === 'lideres_coordinadores'
                    ? 'bg-emerald-500/20 text-emerald-300 border border-emerald-500/40 font-extrabold shadow'
                    : 'text-slate-400 hover:text-slate-200 hover:bg-slate-800/60'
                }`}
              >
            ...
            {/* ---------------------------------------------------------------------- */}
            {formTypeSubTab === 'votantes' && (
              <div className="bg-[#041733]/90 rounded-2xl p-6 border border-cyan-500/30 shadow-xl space-y-4">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 border-b border-cyan-500/20 pb-4">
                  <div>
                    ...
                    <p className="text-xs text-cyan-200/80 mt-0.5">
                      Establezca cómo registrarán los líderes a los votantes en campo y personalice los campos de captación de información.
                    </p>
                  </div>
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className="px-4 py-2 bg-cyan-600 text-white font-extrabold text-xs rounded-xl shadow hover:bg-cyan-500 transition-all flex items-center gap-1.5 cursor-pointer shrink-0"
                    >
                ...
                <div className="bg-[#030d1f] text-white rounded-2xl p-4 border border-cyan-500/30 space-y-3">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                  ...
                  <div className="flex flex-col sm:flex-row gap-2">
                    <input
                      ...
                      className="flex-1 bg-slate-950 border border-cyan-500/30 rounded-xl px-3 py-2 text-xs text-white focus:outline-none focus:border-cyan-400 font-mono"
                    />
                    <button
                      onClick={handleSearchCedula}
                      className="px-4 py-2 bg-cyan-500 text-slate-950 font-black text-xs rounded-xl hover:bg-cyan-400 cursor-pointer"
                    >
                      Validar Cédula
                    </button>
                  </div>
                  ...
                  {duplicateWarning && (
                    <div className="p-3 bg-rose-500/20 border border-rose-400/40 text-rose-300 rounded-xl text-xs flex items-center gap-2">
                  ...
                  {cedulaSearchResult && !duplicateWarning && (
                    <div className="p-3 bg-emerald-500/20 border border-emerald-400/40 text-emerald-300 rounded-xl text-xs space-y-1">
                ...
                {/* Field Configurator */}
                <div className="bg-[#030d1f] border border-cyan-500/30 p-5 rounded-2xl space-y-4">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-cyan-500/20 pb-3">
                    <div>
                      ...
                      <p className="text-xs text-cyan-200/80 mt-0.5">
                        Active o desactive campos y marque cuáles datos son obligatorios para los líderes de campaña al empadronar.
                      </p>
                    </div>
                    <button
                      ...
                      className="px-3 py-1.5 bg-emerald-500 text-slate-950 font-bold text-xs rounded-xl shadow hover:bg-emerald-400 transition-all self-start sm:self-auto cursor-pointer"
                    >
                      Guardar Esquema
                    </button>
                  </div>
                    ...
                    {registrationFields.map((field) => (
                      <div
                        ...
                        className={`p-3 rounded-xl border transition-all ${
                          field.enabled
                            ? 'bg-[#041733] border-cyan-500/30 shadow-md'
                            : 'bg-slate-900/60 border-slate-800 opacity-60'
                        }`}
                      >
                        <div className="flex items-center justify-between mb-1.5">
                          <span className="text-[10px] font-mono font-bold px-1.5 py-0.5 bg-cyan-950 text-cyan-300 border border-cyan-800 rounded">
                            {field.category}
                          </span>
                          {field.system ? (
                            <span className="text-[9px] bg-cyan-500/20 text-cyan-300 font-bold px-1.5 py-0.5 rounded border border-cyan-500/40">
                              Campo del Sistema
                            </span>
                          ) : (
                            <button
                        ...
                        <div className="font-bold text-xs text-white">{field.name}</div>
                        <div className="text-[10px] text-cyan-200/70 font-mono">Tipo: {field.type}</div>

                        <div className="flex items-center justify-between mt-2.5 pt-2 border-t border-cyan-500/15 text-[10px]">
                          <span className="text-slate-400">Requerido en Formulario:</span>
                          {field.system ? (
                            <span className="font-bold text-cyan-400">Obligatorio</span>
                          ) : (
                            <button
                ...
                {showAddVoterForm && (
                  <form onSubmit={handleAddVoterSubmit} className="bg-cyan-50/70 border-2 border-cyan-300 p-5 rounded-2xl space-y-4 text-xs animate-fadeIn shadow-sm">
                    <div className="flex items-center justify-between border-b border-cyan-200 pb-2">
                      ...
                      <span className="text-[10px] bg-cyan-200 text-cyan-900 font-bold px-2 py-0.5 rounded">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-3.5">
                      <div>
                        <label className="block text-[10px] font-bold text-slate-700 mb-1">
                          Cédula de Ciudadanía * <span className="text-cyan-700 font-normal">(Censo Electoral)</span>
                        </label>
                        <input
                          type="text"
                          required
                      ...
                      <div>
                        <label className="block text-[10px] font-bold text-slate-700 mb-1">Líder Asignado *</label>
                        <input
                          type="text"
                          required
                          value={newLider}
                      ...
                      <div>
                        <label className="block text-[10px] font-bold text-slate-700 mb-1">Comuna / Sector *</label>
                        <input
                          type="text"
                          value={newComuna}
                      ...
                      <div>
                        <label className="block text-[10px] font-bold text-slate-700 mb-1">Puesto de Votación</label>
                        <input
                          type="text"
                          value={newPuesto}
                      ...
                      <div>
                        <label className="block text-[10px] font-bold text-slate-700 mb-1">Mesa</label>
                        <input
                          type="text"
                          value={newMesa}
                      ...
                      <div className="md:col-span-3">
                        ...
                        <textarea
                          ...
                          className="w-full bg-white border border-slate-300 rounded-xl px-3 py-2 text-slate-900 focus:outline-none focus:border-cyan-500"
                        />
                      </div>
                    </div>
                    ...
                    <div className="flex justify-end gap-2 pt-2 border-t border-cyan-200">
                      <button
                        ...
                        className="px-3 py-1.5 bg-slate-200 text-slate-700 font-bold rounded-xl cursor-pointer"
                      >
                        Cancelar
                      </button>
                      <button
                        type="submit"
                        className="px-4 py-1.5 bg-cyan-700 text-white font-bold rounded-xl shadow hover:bg-cyan-600 cursor-pointer"
                      >
                        Probar Guardado
                      </button>
                    </div>
            ...
            {formTypeSubTab === 'lideres_coordinadores' && (
              <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm space-y-6">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 border-b border-slate-100 pb-4">
                  <div>
                    ...
                    <p className="text-xs text-slate-500 mt-0.5">
                      Establezca la estructura, reglas de validación y datos requeridos para vincular Líderes Zonales, Coordinadores de Puesto y Coordinadores de Zona.
                    </p>
                  </div>
                ...
                {/* Rules & Anti-Duplicate Banner */}
                <div className="bg-slate-900 text-white rounded-2xl p-4 border border-purple-500/30 space-y-3">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <Shield className="w-4 h-4 text-purple-400" />
                      <h4 className="text-xs font-bold text-purple-300">Regla de Negocio: Asignación Territorial & Exclusividad por Cédula</h4>
                    </div>
                    <span className="text-[10px] bg-purple-950 text-purple-300 px-2 py-0.5 rounded border border-purple-700/50 font-mono">
                      Jerarquía RBAC Granular + PostGIS
                    </span>
                  </div>
                  <p className="text-[11px] text-slate-300">
                    Cada Líder o Coordinador registrado debe estar asociado a una única comuna o zona territorial, con metas de votantes cuantificables y supervisor asignado para garantizar la trazabilidad operacional.
                  </p>
                </div>
                ...
                <div className="bg-purple-50/50 border border-purple-100 p-5 rounded-2xl space-y-4">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-purple-200/60 pb-3">
                    <div>
                      ...
                      <p className="text-xs text-slate-500 mt-0.5">
                        Active o modifique la obligatoriedad de los datos capturados durante el onboarding de personal operativo.
                      </p>
                    </div>
                    <button
                    ...
                    {leaderRegistrationFields.map((field) => (
                      ...
                      >
                        <div className="flex items-center justify-between mb-1.5">
                          ...
                          {field.system ? (
                            <span className="text-[9px] bg-purple-200 text-purple-900 font-bold px-1.5 py-0.5 rounded">
                              Base Estructura
                            </span>
                          ) : (
                            <button
                        ...
                        <div className="text-[10px] text-slate-500 font-mono">Tipo: {field.type}</div>

                        <div className="flex items-center justify-between mt-2.5 pt-2 border-t border-slate-100 text-[10px]">
                          <span className="text-slate-500">Obligatoriedad:</span>
                          {field.system ? (
                            <span className="font-bold text-purple-800">Obligatorio</span>
                          ) : (
                            <button
                ...
                {showAddLeaderForm && (
                  <form onSubmit={handleAddLeaderSubmit} className="bg-purple-50/80 border-2 border-purple-300 p-5 rounded-2xl space-y-4 text-xs animate-fadeIn shadow-sm">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-3.5">
                      {/* Cédula */}
                      <div>
                        <label className="block text-[10px] font-bold text-slate-700 mb-1">Cédula de Ciudadanía *</label>
                        <input
                          type="text"
                          required
                          value={newLeaderCc}
                          ...
                          className="w-full bg-white border border-purple-300 rounded-xl px-3 py-1.5 text-slate-900 focus:outline-none focus:border-purple-600 font-mono"
                        />
                      </div>
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className="w-full bg-white border border-purple-300 rounded-xl px-3 py-1.5 text-slate-900 focus:outline-none focus:border-purple-600"
                        />
                      </div>

                      {/* Cargo / Rol Jerárquico */}
                      <div>
                        <label className="block text-[10px] font-bold text-slate-700 mb-1">Cargo / Rol en Estructura *</label>
                        <select
                          value={newLeaderCargo}
                          onChange={(e) => setNewLeaderCargo(e.target.value)}
                          className="w-full bg-white border border-purple-300 rounded-xl px-3 py-1.5 text-slate-900 focus:outline-none focus:border-purple-600 font-medium"
                        >
                      ...
                      <div>
                        <label className="block text-[10px] font-bold text-slate-700 mb-1">Zona / Comuna Asignada *</label>
                        <input
                          type="text"
                          required
                          value={newLeaderZona}
                      ...
                      {/* Teléfono Móvil / WhatsApp */}
                      <div>
                        <label className="block text-[10px] font-bold text-slate-700 mb-1">Teléfono Móvil / WhatsApp *</label>
                        <input
                          type="tel"
                          required
                      ...
                      <div>
                        <label className="block text-[10px] font-bold text-slate-700 mb-1">Correo Electrónico</label>
                        <input
                          type="email"
                      ...
                      {/* Seudónimo / Alias */}
                      <div>
                        <label className="block text-[10px] font-bold text-slate-700 mb-1">Seudónimo / Alias Operativo</label>
                        <input
                          type="text"
                      ...
                      {/* Cumpleaños */}
                      <div>
                        <label className="block text-[10px] font-bold text-slate-700 mb-1">Fecha de Cumpleaños</label>
                        <input
                          type="date"
                      ...
                      {/* Meta de Votantes */}
                      <div>
                        <label className="block text-[10px] font-bold text-slate-700 mb-1">Meta de Votantes (Cuota) *</label>
                        <input
                          type="number"
                          required
                      ...
                      <div className="md:col-span-2">
                        <label className="block text-[10px] font-bold text-slate-700 mb-1">Dirección Residencia / Sede Zonal</label>
                        <input
                          type="text"
                      ...
                      {/* Supervisor / Superior */}
                      <div>
                        <label className="block text-[10px] font-bold text-slate-700 mb-1">Coordinador Superior *</label>
                        <input
                          type="text"
                          required
                      ...
                      <div className="md:col-span-3">
                        <label className="block text-[10px] font-bold text-slate-700 mb-1">Documentos / Estado de Acreditación CNE / ARL</label>
                        <input
                          type="text"
                      ...
                      <div className="md:col-span-3">
                        <label className="block text-[10px] font-bold text-slate-700 mb-1">Experiencia Política & Hoja de Ruta</label>
                        <textarea
                          rows={2}
                          ...
                          className="w-full bg-white border border-purple-300 rounded-xl px-3 py-2 text-slate-900 focus:outline-none focus:border-purple-600"
                        />
                      </div>
                    </div>
                    ...
                    <div className="flex justify-end gap-2 pt-2 border-t border-purple-200">
                      ...
                      <button
                        type="submit"
                        className="px-4 py-1.5 bg-purple-800 text-white font-bold rounded-xl shadow hover:bg-purple-700 cursor-pointer"
                      >
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-xs text-slate-500">
                      Total Registrados: <strong className="text-purple-900">{leadersAndCoordinators.length}</strong>
                    </span>
                  </div>
                  ...
                  <div className="overflow-x-auto border border-slate-200 rounded-xl bg-white">
                    <table className="w-full text-left text-xs border-collapse">
                      <thead>
                        <tr className="bg-purple-50/80 text-purple-950 font-bold border-b border-purple-200">
                      ...
                      <tbody className="divide-y divide-slate-100 font-medium">
                        {leadersAndCoordinators.map((l) => (
                          <tr key={l.id} className="hover:bg-purple-50/30 transition-colors">
                            <td className="p-3 font-mono font-bold text-purple-900">{l.cc}</td>
                            <td className="p-3">
                              <div className="font-bold text-slate-900">{l.nombre}</div>
                              {l.seudonimo && (
                            ...
                            <td className="p-3">
                              <span className="px-2 py-0.5 bg-purple-100 text-purple-900 text-[10px] font-extrabold rounded">
                                {l.cargo}
                              </span>
                              <div className="text-[10px] text-slate-500 mt-0.5">{l.zona}</div>
                            </td>
                            ...
                            <td className="p-3 text-center">
                              <span className="px-2 py-1 bg-amber-50 text-amber-900 font-bold text-xs rounded-lg border border-amber-200">
                                {l.metaVotantes}
                              </span>
                            </td>
                            <td className="p-3 text-slate-700 font-semibold">{l.supervisor}</td>
                            <td className="p-3 text-center">
                              <button
                                onClick={() => setSelectedLeaderDetail(l)}
                                className="px-2.5 py-1 bg-purple-100 hover:bg-purple-200 text-purple-900 font-bold text-[11px] rounded-lg border border-purple-300 transition-all cursor-pointer"
                              >
                                Ver Expediente
                              </button>
                            </td>
                    ...
                    <div className="bg-white rounded-2xl max-w-lg w-full p-6 space-y-4 shadow-2xl border border-slate-200">
                      <div className="flex items-center justify-between border-b border-slate-100 pb-3">
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            <h4 className="font-bold text-slate-900 text-sm">Expediente de Líder / Coordinador de Zona</h4>
                            <p className="text-[10px] text-slate-500">CC: {selectedLeaderDetail.cc}</p>
                          </div>
                        </div>
                        <button
                      ...
                      <div className="grid grid-cols-2 gap-3 text-xs">
                        <div className="p-2.5 bg-slate-50 rounded-xl border border-slate-100 space-y-0.5">
                          <div className="text-[10px] font-bold text-slate-500">Nombre Completo</div>
                          <div className="font-bold text-slate-900">{selectedLeaderDetail.nombre}</div>
                        </div>

                        <div className="p-2.5 bg-slate-50 rounded-xl border border-slate-100 space-y-0.5">
                          <div className="text-[10px] font-bold text-slate-500">Cargo Jerárquico</div>
                          <div className="font-bold text-purple-900">{selectedLeaderDetail.cargo}</div>
                        </div>

                        <div className="p-2.5 bg-slate-50 rounded-xl border border-slate-100 space-y-0.5">
                          <div className="text-[10px] font-bold text-slate-500">Zona / Comuna Asignada</div>
                          <div className="font-bold text-slate-800">{selectedLeaderDetail.zona}</div>
                        </div>

                        <div className="p-2.5 bg-slate-50 rounded-xl border border-slate-100 space-y-0.5">
                          <div className="text-[10px] font-bold text-slate-500">Meta Cuota de Votantes</div>
                          <div className="font-bold text-amber-800">{selectedLeaderDetail.metaVotantes} Votantes</div>
                        </div>

                        <div className="p-2.5 bg-slate-50 rounded-xl border border-slate-100 space-y-0.5">
                          <div className="text-[10px] font-bold text-slate-500">Teléfono / WhatsApp</div>
                          <div className="font-mono font-bold text-slate-800">{selectedLeaderDetail.telefono}</div>
                        </div>

                        <div className="p-2.5 bg-slate-50 rounded-xl border border-slate-100 space-y-0.5">
                          <div className="text-[10px] font-bold text-slate-500">Coordinador Superior</div>
                          <div className="font-bold text-slate-800">{selectedLeaderDetail.supervisor}</div>
                        </div>

                        <div className="col-span-2 p-2.5 bg-slate-50 rounded-xl border border-slate-100 space-y-0.5">
                          <div className="text-[10px] font-bold text-slate-500">Documentación & Acreditación</div>
                          <div className="font-medium text-slate-800">{selectedLeaderDetail.documentos}</div>
                        </div>

                        <div className="col-span-2 p-2.5 bg-slate-50 rounded-xl border border-slate-100 space-y-1">
                          <div className="text-[10px] font-bold text-slate-500">Experiencia Política & Hoja de Ruta</div>
                          <p className="text-slate-700 leading-relaxed text-[11px]">{selectedLeaderDetail.descripcion}</p>
                        </div>
                      </div>
                    ...
                    <div className="bg-white rounded-2xl max-w-lg w-full p-6 space-y-4 shadow-2xl border border-slate-200">
                      <div className="flex items-center justify-between border-b border-slate-100 pb-3">
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            <h4 className="font-bold text-slate-900 text-sm">Ficha Completa del Votante</h4>
                            <p className="text-[10px] text-slate-500">CC: {selectedVoterDetail.cc}</p>
                          </div>
                        </div>
                        <button
                      ...
                      <div className="grid grid-cols-2 gap-3 text-xs">
                        <div className="p-2.5 bg-slate-50 rounded-xl border border-slate-100 space-y-0.5">
                          <div className="text-[10px] font-bold text-slate-500">Nombre Completo</div>
                          <div className="font-bold text-slate-900">{selectedVoterDetail.nombre}</div>
                        </div>

                        <div className="p-2.5 bg-slate-50 rounded-xl border border-slate-100 space-y-0.5">
                          <div className="text-[10px] font-bold text-slate-500">Seudónimo / Alias</div>
                          <div className="font-bold text-cyan-800">{selectedVoterDetail.seudonimo || 'Sin alias'}</div>
                        </div>

                        <div className="p-2.5 bg-slate-50 rounded-xl border border-slate-100 space-y-0.5">
                          <div className="text-[10px] font-bold text-slate-500">Correo Electrónico</div>
                          <div className="font-medium text-slate-800 break-all">{selectedVoterDetail.email || 'No registrado'}</div>
                        </div>

                        <div className="p-2.5 bg-slate-50 rounded-xl border border-slate-100 space-y-0.5">
                          <div className="text-[10px] font-bold text-slate-500">Teléfono / WhatsApp</div>
                          <div className="font-mono font-bold text-slate-900">{selectedVoterDetail.telefono || 'Sin número'}</div>
                        </div>

                        <div className="p-2.5 bg-slate-50 rounded-xl border border-slate-100 space-y-0.5">
                          <div className="text-[10px] font-bold text-slate-500">Fecha de Cumpleaños</div>
                          <div className="font-medium text-slate-800">{selectedVoterDetail.cumpleanos || 'No registrada'}</div>
                        </div>

                        <div className="p-2.5 bg-slate-50 rounded-xl border border-slate-100 space-y-0.5">
                          <div className="text-[10px] font-bold text-slate-500">Líder Asignado</div>
                          <div className="font-bold text-slate-900">{selectedVoterDetail.lider}</div>
                        </div>

                        <div className="col-span-2 p-2.5 bg-slate-50 rounded-xl border border-slate-100 space-y-0.5">
                          <div className="text-[10px] font-bold text-slate-500">Dirección de Residencia</div>
                          <div className="font-medium text-slate-800">{selectedVoterDetail.direccion || 'Sin dirección'}</div>
                        </div>

                        <div className="col-span-2 p-2.5 bg-slate-50 rounded-xl border border-slate-100 space-y-0.5">
                          <div className="text-[10px] font-bold text-slate-500">Puesto & Mesa (Censo)</div>
                          <div className="font-medium text-slate-800">{selectedVoterDetail.puesto} ({selectedVoterDetail.mesa}) • {selectedVoterDetail.comuna}</div>
                        </div>
            ...
            <div className="bg-[#041733]/90 rounded-2xl p-6 border border-cyan-500/30 shadow-xl space-y-4">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-cyan-500/20 pb-4">
                ...
                <div className="flex items-center gap-2 shrink-0">
                  {/* Simulation Toggle for Campaign Existence */}
                  <button
                    ...
                    title="Haga clic para simular el estado de existencia de una campaña creada"
                  >
                    <Building className="w-3.5 h-3.5" />
                    <span>{hasActiveCampaign ? 'Campaña Activa: Creada ✅' : 'Estado: Sin Campaña Creada ⚠️'}</span>
                  </button>
              ...
              {!hasActiveCampaign && (
                <div className="bg-gradient-to-r from-amber-500/10 via-orange-500/10 to-amber-500/10 border-2 border-amber-500/40 rounded-2xl p-6 shadow-xl space-y-4 text-center my-2">
                  <div className="w-12 h-12 bg-amber-500/20 text-amber-300 rounded-2xl flex items-center justify-center mx-auto border border-amber-400/50">
                  ...
                  <div className="pt-2 flex flex-col sm:flex-row items-center justify-center gap-3">
                    <button
                      onClick={() => setActiveTab('gestion_campana')}
                      className="px-5 py-2.5 bg-teal-500 text-slate-950 font-extrabold text-xs rounded-xl shadow hover:bg-teal-400 transition-all flex items-center gap-2 cursor-pointer"
                    >
              ...
              {hasActiveCampaign && (
                <>
                  ...
                  <div className="bg-[#030d1f] border border-cyan-500/30 rounded-xl p-3.5 flex flex-col md:flex-row md:items-center justify-between gap-3 text-xs text-cyan-200">
                    ...
                    <div className="flex items-center gap-2 text-[11px] font-bold">
                      <span className="bg-[#051833] px-2.5 py-1 rounded-lg border border-cyan-500/30 text-cyan-300">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
                      {partidosPoliticosOpt.slice(0, 4).map((partido, idx) => {
                        ...
                        return (
                          <div key={idx} className="p-3.5 bg-[#030d1f] rounded-xl border border-cyan-500/30 flex flex-col justify-between space-y-2">
                            <div className="flex items-center justify-between">
                        ...
                        <div>
                          <div className="flex items-center gap-2">
                            ...
                            <span className={`px-2.5 py-0.5 text-[10px] font-extrabold uppercase tracking-wider rounded-full border ${
                              ...
                              {geofenceActive ? '● Geocerca Activa' : '○ Desactivado'}
                            </span>
                          </div>
                      ...
                      <div className="flex items-center gap-2 shrink-0">
                        ...
                        <button
                          ...
                          className={`px-4 py-2 text-xs font-black rounded-xl border transition-all cursor-pointer flex items-center gap-2 ${
                            geofenceActive 
                              ? 'bg-emerald-600 text-white border-emerald-400 hover:bg-emerald-500 shadow-lg' 
                      ...
                      <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 pt-1">
                        ...
                        <div className="lg:col-span-7 bg-slate-800/60 border border-indigo-500/20 rounded-xl p-4 flex flex-col justify-between space-y-4">
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-12 gap-4 items-center">
                            ...
                            <div className="sm:col-span-6 flex flex-col items-center justify-center p-3 bg-slate-950/80 rounded-2xl border border-indigo-500/30 relative min-h-[200px]">
                              {/* Radar Background grid rings */}
                              <div className="w-36 h-36 rounded-full border border-indigo-500/20 flex items-center justify-center relative">
                                <div className="w-24 h-24 rounded-full border border-indigo-500/40 flex items-center justify-center">
                                  {/* Dynamic Geofence Perimeter Circle */}
                                  <div className="w-16 h-16 rounded-full border-2 border-dashed border-emerald-400/80 bg-emerald-500/10 flex items-center justify-center animate-pulse relative">
                                    {/* Central Polling Station Icon */}
                                    <div className="w-7 h-7 bg-indigo-600 rounded-full flex items-center justify-center shadow-[0_0_12px_rgba(99,102,241,0.8)] border border-white">
                                  ...
                                  .map((t, idx) => {
                                    ...
                                    return (
                                      <div
                                        ...
                                        title={`${t.nombre}: ${gps.distanciaMetros}m (${isInside ? 'DENTRO' : 'FUERA'})`}
                                      >
                                        <div className={`w-4 h-4 rounded-full flex items-center justify-center font-black text-[8px] text-white shadow-md transition-all ${
                                          isInside 
                              ...
                              <div className="text-[10px] text-slate-400 mt-2 text-center font-mono">
                                Centro: Puesto Votación | Cerco: {geofenceRadius}m
                              </div>
                            </div>
                  ...
                  <div className="flex flex-col md:flex-row items-stretch md:items-center justify-between gap-3 pt-2">
                    <div className="flex flex-wrap items-center gap-2 flex-1">
                      ...
                      <div className="relative min-w-[200px]">
                        ...
                        <input
                          ...
                          className="w-full bg-slate-50 border border-slate-200 rounded-xl pl-8 pr-3 py-1.5 text-xs focus:outline-none focus:border-indigo-500"
                        />
                      </div>
                    ...
                    <button
                      ...
                      className="px-4 py-2 bg-emerald-600 text-white font-extrabold text-xs rounded-xl shadow hover:bg-emerald-500 transition-all flex items-center justify-center gap-1.5 cursor-pointer shrink-0"
                    >
                  ...
                  {showWitnessForm && (
                    <form onSubmit={handleSaveWitness} className="bg-slate-50 border-2 border-indigo-200 rounded-2xl p-5 space-y-4 animate-fadeIn">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 text-xs">
                        <div>
                          ...
                          <input
                            ...
                            className="w-full p-2 bg-white border border-slate-300 rounded-xl font-medium focus:outline-none focus:border-indigo-500"
                          />
                        </div>
                        ...
                        <div className="md:col-span-2">
                          <label className="block font-bold text-slate-700 mb-1">Partido Político o Movimiento *</label>
                          <select
                            value={witPartido}
                        ...
                        <div>
                          <label className="block font-bold text-slate-700 mb-1">Puesto de Votación (Territorio) *</label>
                          <select
                            value={witPuesto}
                            onChange={(e) => {
                        ...
                        {/* Asignación de Mesa */}
                        <div>
                          <label className="block font-bold text-slate-700 mb-1">Mesa Asignada *</label>
                          <select
                            value={witMesa}
                      ...
                      <div className="flex items-center justify-end gap-2 pt-2 border-t border-slate-200">
                        <button
                          type="button"
                          onClick={resetWitnessForm}
                          className="px-4 py-2 bg-white text-slate-700 border border-slate-300 font-bold text-xs rounded-xl hover:bg-slate-100 transition-all cursor-pointer"
                        >
                          Cancelar
                        </button>
                        <button
                            ...
                            return (
                              <tr key={t.id} className="hover:bg-slate-50 transition-colors">
                                <td className="p-3">
                                  ...
                                  <div className="text-[10px] text-slate-500 font-mono">CC: {t.cc}</div>
                                  <div className="text-[10px] text-slate-400">{t.telefono}</div>
                                </td>
                                <td className="p-3">
                                  <span className="px-2 py-0.5 bg-indigo-50 text-indigo-900 border border-indigo-200 font-bold text-[10px] rounded-md block w-fit">
                                    {t.partido}
                                  </span>
                                </td>
                                <td className="p-3 text-slate-700 font-semibold">{t.rol}</td>
                                <td className="p-3">
                                  <div className="font-bold text-slate-900">{t.puesto}</div>
                                  <div className="text-[10px] text-indigo-600 font-bold">{t.mesa} ({t.comuna})</div>
                                </td>
                                <td className="p-3">
                                  {!geofenceActive ? (
                                    <span className="px-2 py-0.5 bg-slate-100 text-slate-600 border border-slate-300 font-bold text-[10px] rounded">
                                      Desactivado
                                    </span>
                                  ) : isInsideGeofence ? (
                                    <div className="flex items-center gap-1.5">
                                      <span className="px-2 py-0.5 bg-emerald-100 text-emerald-800 border border-emerald-300 font-black text-[10px] rounded flex items-center gap-1">
                                    ...
                                    <div className="flex items-center gap-1.5">
                                      <span className="px-2 py-0.5 bg-rose-100 text-rose-800 border border-rose-300 font-black text-[10px] rounded flex items-center gap-1 animate-pulse">
                                ...
                                <td className="p-3 text-indigo-700 font-semibold">{t.acreditacion}</td>
                                <td className="p-3">
                      ...
                      {puestosTerritorioOpt.map((pst, idx) => {
                        ...
                        return (
                          <div key={idx} className="bg-white p-3 rounded-xl border border-slate-200 space-y-1.5">
                            <div className="flex items-center justify-between">
                              <span className="font-extrabold text-slate-900">{pst.nombre}</span>
                            ...
                            <div className="pt-1 flex items-center justify-between text-[10px]">
                              <span className="text-slate-600">Testigos Asignados: <strong className="text-indigo-900">{testigosEnPuesto.length}</strong></span>
                              <span className="text-emerald-700 font-extrabold">
                                {testigosEnPuesto.length > 0 ? 'Cubierto ✅' : 'Pendiente Asignar ⚠️'}
                              </span>
                            </div>
                          </div>
                        );
        ...
        {activeTab === 'jurados_electorales' && (
          <div className="space-y-6 animate-fadeIn">
            ...
            <div className="bg-[#041733]/90 rounded-2xl p-6 border border-cyan-500/30 shadow-xl space-y-6">
              ...
              {/* Cuadro Legal Informativo de la Registraduría Nacional */}
              <div className="bg-slate-50 border border-slate-200 rounded-2xl p-4 space-y-2 text-xs">
                <h5 className="font-extrabold text-slate-900 flex items-center gap-1.5 uppercase tracking-wider text-[11px]">
                  <ShieldCheck className="w-4 h-4 text-purple-600" />
                  <span>Marco Legal Registraduría Nacional para Postulación de Jurados por Partidos</span>
                </h5>
                <p className="text-slate-600 leading-relaxed text-[11px]">
                  De conformidad con la reglamentación electoral colombiana (Decreto 2241 y Ley 1475 de 2011), los partidos y movimientos políticos con personería jurídica tienen derecho a presentar listas de ciudadanos para el sorteo electrónico oficial de jurados de votación. La plataforma genera el archivo estandarizado exigido por las delegaciones de la Registraduría y permite auditar en tiempo real la resolución final de sorteo aprobada por los Claveros y la autoridad electoral.
                </p>
              </div>
            </div>
          </div>
