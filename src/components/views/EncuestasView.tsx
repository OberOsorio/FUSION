...
export const EncuestasView: React.FC<EncuestasViewProps> = ({ onSelectView, authUser }) => {
  ...
  const handleDeletEncuesta = (id: string) => {
    // Only administrators or coordinators can delete
    if (authUser?.role === 'encuestador') {
      alert('Error: Los usuarios encuestadores no tienen permisos para eliminar encuestas.');
      return;
    }
