        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 relative z-10">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            <button
              ...
              className="flex items-center gap-2 px-4 py-2.5 bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-black text-xs rounded-xl shadow-lg transition-all cursor-pointer transform hover:scale-105"
            >
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-3 mt-6 pt-5 border-t border-cyan-500/20">
          <div className="bg-[#081d38] border border-cyan-500/20 rounded-xl p-3">
            ...
            <div className="text-xl font-black text-white mt-1 flex items-center gap-2">
              ...
              <span className="text-[10px] text-emerald-400 font-normal bg-emerald-500/10 px-1.5 py-0.5 rounded border border-emerald-500/20">2 en campo</span>
            </div>
          </div>
                  ...
                  <div className="pt-3 border-t border-cyan-500/15 flex items-center justify-between gap-2">
                    ...
                    <div className="flex items-center gap-1">
                      <button
                        ...
                        className="px-2.5 py-1.5 bg-emerald-500/20 hover:bg-emerald-500/30 text-emerald-300 border border-emerald-500/40 rounded-lg text-xs font-bold flex items-center gap-1 cursor-pointer"
                      >
                    ...
                    >
                      <Popup className="custom-leaflet-popup">
                        <div className="text-xs p-1 font-sans">
                          ...
                          <span className="text-slate-600">Perímetro de control GPS: {zone.radius}m</span>
                        </div>
                      </Popup>
                    </Circle>
                  ))}
        ...
        <div className="bg-[#05162a] border border-cyan-500/30 rounded-2xl p-6 text-slate-100 shadow-xl space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
            ...
            <div className="md:col-span-7 space-y-4">
              ...
              {[
                { candidate: 'Nuestro Candidato (Campaña Ganadora)', percentage: 38.5, votes: 2075, color: 'bg-emerald-500', isUs: true },
                { candidate: 'Candidato Oposición A', percentage: 27.2, votes: 1466, color: 'bg-blue-500', isUs: false },
                { candidate: 'Candidato Oposición B', percentage: 14.8, votes: 797, color: 'bg-amber-500', isUs: false },
                { candidate: 'Indecisos / No Sabe No Responde', percentage: 11.5, votes: 620, color: 'bg-purple-500', isUs: false },
                { candidate: 'Voto en Blanco', percentage: 8.0, votes: 432, color: 'bg-slate-500', isUs: false },
              ].map((item, idx) => (
          ...
          <div className="bg-[#05162a] border border-cyan-500/40 rounded-2xl max-w-lg w-full p-6 space-y-5 text-slate-100 shadow-2xl animate-in fade-in zoom-in-95 duration-150">
            ...
            <form onSubmit={handleAddPollsterSubmit} className="space-y-4 text-xs">
              ...
              <div className="pt-3 border-t border-cyan-500/20 flex justify-end gap-2">
                ...
                <button
                  type="submit"
                  className="px-5 py-2 bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-black rounded-xl shadow cursor-pointer flex items-center gap-1.5"
                >
                  <CheckCircle2 className="w-4 h-4" />
