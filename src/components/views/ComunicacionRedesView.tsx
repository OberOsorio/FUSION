        ...
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6 relative z-10">
          <div className="space-y-2 max-w-2xl">
            <div className="flex items-center gap-2 flex-wrap">
              <span className="px-3 py-0.5 rounded-full bg-purple-500/20 border border-purple-400/40 text-purple-300 font-extrabold text-[10px] uppercase tracking-wider flex items-center gap-1.5 shadow">
                <Share2 className="w-3.5 h-3.5 text-purple-400 animate-pulse" /> Cuartel Digital de Comunicaciones
              </span>
              <span className="bg-emerald-500/20 text-emerald-300 text-[10px] font-black px-2.5 py-0.5 rounded-full border border-emerald-400/40 flex items-center gap-1">
